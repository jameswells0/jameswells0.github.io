...
function dizme_tm_service_popup() {
    ...
    button.on('click', function () {
        ...
        modalBox.find('.service_popup_informations').prepend('<div class="image"><img src="assets/4-2.jpg" alt="" /><div class="main" data-img-url="' + elImage + '"></div></div>');
        dizme_tm_data_images();
...
function dizme_tm_modalbox_news() {
    ...
    button.on('click', function () {
        ...
        modalBox.addClass('opened');
        modalBox.find('.description_wrap').html(content);
        modalBox.find('.news_popup_informations').prepend('<div class="image"><img src="assets/4-2.jpg" alt="" /><div class="main" data-img-url="' + image + '"></div></div>');
...
function dizme_tm_modalbox_portfolio() {
    ...
    button.off().on('click', function () {
        ...
        modalBox.addClass('opened');
        modalBox.find('.description_wrap').html(content);
        modalBox.find('.popup_details').prepend('<div class="top_image"><img src="assets/4-2.jpg" alt="" /><div class="main" data-img-url="' + image + '"></div></div>');
...
function dizme_tm_down() {
    ...
    jQuery('.anchor').on('click', function () {
        if ($.attr(this, 'href') !== '#') {
            $('html, body').animate({
                scrollTop: $($.attr(this, 'href')).offset().top - topbar - 105
            }, 800);
        }
        return false;
    });
